...
@Component({
  ...
  standalone: true,
  imports: [InfoProductoComponent, CommonModule, FormsModule, NgbModule],
...
export class AddinfoproductComponent {
  ...
  constructor(private renderer: Renderer2, private infoproductService: InfoproductService, private modalService: NgbModal) {}
